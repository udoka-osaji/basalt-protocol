...
import { DEPLOYER, EXPLORER_URL, NETWORK } from '@/config/contracts';
...
export function Footer() {
  return (
    <footer className="w-full border-t border-border mt-auto py-6 text-foreground-tertiary body-sm">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="flex items-center gap-2">
          <span className="text-foreground-secondary">© {new Date().getFullYear()} Basalt Protocol</span>
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            href={`${EXPLORER_URL}/address/${DEPLOYER}?chain=${NETWORK}`}
            target="_blank"
            rel="noopener noreferrer"
